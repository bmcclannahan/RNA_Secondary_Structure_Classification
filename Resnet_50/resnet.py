...
data_dir = "/scratch/RNA_Secondary_Structure_Classification/Small_Training_Set"
...
def train_model(model, dataloaders, criterion, optimizer, schedular, num_epoch=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            torch.save(per_epoch_model, './resnet/chekers/epoch'+str(epoch)+'.pt')
    ...
    torch.save(best_model_wts, './resnet/checkpoints/weight.pt')
