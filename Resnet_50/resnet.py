...
def train_model(model, dataloaders, criterion, optimizer, schedular, num_epoch=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            torch.save(per_epoch_model, '/users/b523m844/RNA_Secondary_Structure_Classification/Resnet_50/resnet/chekers/epoch'+str(epoch)+'.pt')
    ...
    torch.save(best_model_wts, '/users/b523m844/RNA_Secondary_Structure_Classification/Resnet_50/resnet/checkpoints/weight.pt')
