...
def train_model(model, dataloaders, criterion, optimizer, schedular, num_epoch=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ft = open("/scratch/b523m844/RNA_Secondary_Structure_Classification/vggnet/train_result.txt", "a") 
        fp = open("/scratch/b523m844/RNA_Secondary_Structure_Classification/vggnet/test_result.txt","a")
    ...
    torch.save(best_model_wts, '/scratch/b523m844/RNA_Secondary_Structure_Classification/vggnet/checkpoints/weight.pt')
