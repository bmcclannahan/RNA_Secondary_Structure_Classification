...
def test_model(model,dataloaders):
    best_model_wts = torch.load("/scratch/b523m844/RNA_Secondary_Structure_Classification/inception/chekers/epoch249.pt") 
    ...
    print('Total Accuracy: %2d %%' % (100 * (class_correct[0] + class_correct[1]) / (class_total[0] + class_total[1]))) 
