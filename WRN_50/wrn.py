...
def train_model(model, dataloaders, criterion, optimizer, schedular, num_epoch=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ft = open("/scratch/b523m844/RNA_Secondary_Structure_Classification/wrn/train_result.txt", "a") 
        fp = open("/scratch/b523m844/RNA_Secondary_Structure_Classification/wrn/test_result.txt","a")
        ...
        for phase in ['train', 'val']:
            ...
            torch.save(per_epoch_model, '/scratch/b523m844/RNA_Secondary_Structure_Classification/wrn/chekers/epoch'+str(epoch)+'.pt')
    ...
    torch.save(best_model_wts, '/scratch/b523m844/RNA_Secondary_Structure_Classification/wrn/checkpoints/weight.pt')
