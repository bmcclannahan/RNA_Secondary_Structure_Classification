...
class Siamese_Model(Model):
    ...
    def __init__(self,model_func,model_name,learning_rate=0.001,lr_gamma=0.2,lr_step=300,iteration_limit=400,validation_frequency=25,logging=True,starting_weight=.5,model_type='resnet'):
    ...
    def _test_model(self,model):
        ...
        for index in range(range_length):
            ...
            roc_preds[roc_index:roc_index+label_length] = [x.detach().numpy()[0] for x in cpu_outputs]
