...
class Siamese_Model(Model):
    ...
    def __init__(self,model_func,model_name,learning_rate=0.01,lr_gamma=0.5,lr_step=5,iteration_limit=36,validation_frequency=3,logging=True,starting_weight=.5):
