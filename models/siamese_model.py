...
class Siamese_Model(Model):
    ...
    def __init__(self,model_func,model_name,learning_rate=0.001,lr_gamma=0.25,lr_step=10,iteration_limit=100,validation_frequency=5,logging=True,starting_weight=.5):
