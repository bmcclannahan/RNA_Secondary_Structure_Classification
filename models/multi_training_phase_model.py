...
class Multi_Training_Phase_Model(Model):
    ...
    def __init__(self,model_func,model_name,learning_rate=0.01,lr_gamma=0.25,lr_step=50,iteration_limit=600,iteration_swap_threshold=350,start_weights=[.2,.8],end_weights=[.8,.2]):
